    ...
    content: {
      ui: {
        ...
        categories: {
          ...
          mental_health: "Kesehatan Mental & Kesejahteraan",
    ...
    content: {
      ui: {
        ...
        categories: {
          ...
          mental_health: "Salud Mental y Bienestar",
          nutrition: "Nutrición y Dieta",
          tech: "Tecnología y Programación",
          data: "Ciencia de Datos e IA",
    ...
    content: {
      ui: {
        ...
        categories: {
          ...
          mental_health: "Психическое здоровье и благополучие",
          nutrition: "Питание и диета",
          tech: "Технологии и код",
          data: "Наука о данных и ИИ",
    ...
    content: {
      ui: {
        ...
        categories: {
          ...
          mental_health: "الصحة النفسية والرفاهية",
          nutrition: "التغذية والنظام الغذائي",
          tech: "التكنولوجيا والبرمجة",
          data: "علم البيانات والذكاء الاصطناعي",
